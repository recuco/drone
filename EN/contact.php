...
<section class="contacto">
    ...
    <form>
        ...
        <li>
            ...
            <input name="ciudad" type="text" placeholder="City">
        </li>
        <li>
            <i class="fa fa-phone"></i>
            <input name="telefono" type="text" placeholder="Telephone">
        </li>
        <li>
            <i class="fa fa-comment"></i>
            <input name="comentarios" type="text" placeholder="Comments">
        </li>
        </ul>
        <button class="btn" type="submit" name="enviar"><i class="fa fa-paper-plane"></i> SEND</button>
